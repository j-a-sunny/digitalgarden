---
{"dg-publish":true,"permalink":"/resume/","dg-note-properties":{}}
---


# MD Janey Alom Sunny
<iconify-icon icon="eva:people-outline"></iconify-icon> [example.com](https://example.com/)
  : <iconify-icon icon="tabler:brand-github"></iconify-icon> [https://github.com/j-a-sunny](https://github.com/j-a-sunny)
